...
class TestDecision(TestCase):
    ...
    def test_position_adjustment(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/467381034_PreFlop_0.png', strategy='Pokemon4')
        t.gameStage="PreFlop"
        p = StrategyHandler()
    ...
    def test_preflop_round2(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/378278828_PreFlop_1.png', round_number=1)
        p = StrategyHandler()
    ...
    def test_preflop_round2_2(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/107232845_PreFlop_1.png', round_number=1)
        p = StrategyHandler()
        p.read_strategy('Pokemon4')
        l = MagicMock()
        t.checkButton = False
    ...
    def test_preflop_round2_3(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/897376414_PreFlop_1.png', round_number=1)
        p = StrategyHandler()
        p.read_strategy('Pokemon4')
        l = MagicMock()
        t.checkButton = False
    ...
    def test_preflop_call_before_raise(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/1791526_PreFlop_0.png', round_number=0)
        p = StrategyHandler()
        p.read_strategy('Pokemon4')
        l = MagicMock()
        t.checkButton = False
    ...
    def incorrect_second_raiser(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/Q9o-first_raiser.png', strategy='Snowie3')
        l = MagicMock()
        t.checkButton = False
        d = Decision(t, h, p, l)
        t.isHeadsUp = True
    ...
    def incorrect_preflop_table1(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/K9o.png', strategy='Snowie3')
        l = MagicMock()
        t.checkButton = False
        d = Decision(t, h, p, l)
        t.isHeadsUp = True
    ...
    def incorrect_preflop_table2(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/3Ts.png', strategy='Snowie3')
        l = MagicMock()
        t.checkButton = False
        d = Decision(t, h, p, l)
        t.isHeadsUp = True
    ...
    def second_round_with_raiser(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/QQ.png', strategy='Snowie3', round_number=1)
        l = MagicMock()
        t.checkButton = False
        d = Decision(t, h, p, l)
        t.isHeadsUp = True
    ...
    def first_round_2R1(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/JJ.png', strategy='Snowie3', round_number=0)
        l = MagicMock()
        t.checkButton = False
        d = Decision(t, h, p, l)
        t.isHeadsUp = True
    ...
    def first_round_4R1(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/AJ.png', strategy='Snowie3', round_number=0)
        l = MagicMock()
        t.checkButton = False
        d = Decision(t, h, p, l)
        t.isHeadsUp = True
    ...
    def first_round_98h(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/98h.png', strategy='Snowie3', round_number=0)
        t.checkButton = False
        d = Decision(t, h, p, l)
        t.isHeadsUp = True
        t.gameStage = "PreFlop"
    ...
    def sheet_12R4R6(self):
        t, p, gui_signals, h, logger = init_table('testing/screenshots/12R4R6.png', round_number=1)
        l = MagicMock()
        t.checkButton = False
        d = Decision(t, h, p, l)
        t.isHeadsUp = True
